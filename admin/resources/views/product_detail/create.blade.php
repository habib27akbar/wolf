                ...
                <form action="{{ route('product_detail.store') }}" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="led_chip" id="led_chip" class="form-control" id="led_chip">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="file" class="col-sm-2 col-form-label">Input Voltage(V)</label>
                            <div class="col-sm-10">
                                <input type="text" name="input_voltage" id="input_voltage" class="form-control" id="input_voltage">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('product/'.$_GET['product_id']) }}" class="btn btn-default">Batal</a>
                    </div>
                </form>
            </div>
          </div>
