          ...
          <div class="col-12">
            <div class="card card-primary"> 
              <div class="card-body">
                ...
                <a href="{{ route('carrier.create') }}" class="btn btn-primary">Tambah</a>
                <br/><br/>
                  ...
                  <tbody>
                     @foreach($carrier as $key => $value)
                        <tr>
                            <td>
                                <div class="btn-group">
                                    <form method="POST" action="{{ route('carrier.destroy', ['carrier' => $value->id]) }}">
                                        <a href="{{ route('carrier.edit',$value->id) }}" class="btn-sm btn-warning">Edit</a>
                                        @method('DELETE')
                                        @csrf
