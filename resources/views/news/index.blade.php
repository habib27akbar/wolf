    ...
    <!-- Slider Area Start -->
        ...
        <div class="new-arrival no-border-style ptb-90">
            <div class="container">
                ...
                <!-- Section Title End -->
                 <div class="news-item">
                    <h4 class="news-title">{{ $value['judul'] }}</h4>
                    <img class="news-image" src="{{ env('ASSET_URL_ADMIN') }}/img/news/{{ $value['gambar'] }}" alt="Gambar Berita Pertama">
                    <p class="news-content"><?=substr($value['isi'], 0,20)?></p>
                    <a href="{{ route('news.show',$value->id) }}">Baca Selengkapnya</a>
                </div>
                <br/>
               @endforeach
            </div>
